...
```{r joint-tests}
# First set the reference grid with emmeans, as always
homunculi_emm <- emmeans::emmeans(homunculi_model, specs = "body_type")

# Then run the joint tests
emmeans::joint_tests(homunculi_model, by = "body_type")

# And get the effect size for each test
emmeans::eff_size(
  homunculi_emm,
...
```{r}
homunculi_emm_2 <- emmeans::emmeans(
  homunculi_model,
  specs = "body_type",
  by = "brain_type"
)
